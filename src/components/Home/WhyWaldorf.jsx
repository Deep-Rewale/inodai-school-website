...
const WhyWaldorf = () => {
  return (
    < motion.section initial={{ opacity: 0 }}
      ...
      viewport={{ once: true }} className="py-15 md:py-40 h-full  bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: `url(${bgImage})` }}>
      <div className="full-container max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        {/* left img */}
