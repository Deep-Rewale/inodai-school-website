...
const BoardMembers = () => {
    ...
    return (
        <section className="w-full bg-[#F8F9FC] py-24 px-6">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <h2 className="text-4xl font-heading text-primary font-semibold">
                    ...
                    <p className="text-gray-600 font-body max-w-3xl mx-auto">
                        ...
                        dedication in strengthening the vision and educational foundation
                        of Inodai Waldorf School.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1  gap-10">
                    {members.map((member, index) => (
                        ...
                        >
                            ...
                            >
                                {openIndex === index ? "Read Less" : "Read More"}<span className={`${openIndex === index ? "rotate-180" : "rotate-0"}`}><IoIosArrowDown size={20} /></span>
                            </button>
                        </motion.div>
                    ))}
                </div>
