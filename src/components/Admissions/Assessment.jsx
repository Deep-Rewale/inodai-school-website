...
const Assessment = () => {
  return (
    ...
    whileInView="visible"
    viewport={{ once: true }} className="grid lg:grid-cols-2 grid-cols-1 max-w-7xl mx-auto px-6 gap-10 items-center ">
        {/* let content */}
        <motion.div variants={slideLeft} className="space-y-5">
          <h2 className="text-3xl lg:text-4xl font-semibold font-heading text-primary">Assessment Details</h2>
          ...
          <p className="font-body text-gray-700 lg:text-lg md:text-base" >Our goal is not to test children but to understand them.</p>
        </motion.div>
        {/* right images */}
        <motion.div variants={slideRight}  className="grid md:grid-cols-2   gap-5">
