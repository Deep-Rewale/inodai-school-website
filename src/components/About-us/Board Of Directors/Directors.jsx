...
const directors = [
  ...
  },
  {
    ...
    full: "He teaches Physics and Chemistry, mentors grade teachers and serves on multiple Waldorf education forums. He actively contributes to curriculum development and teacher training programs across the country.",
  },
  {
    name: "Manali Mehta",
    role: "Founder Director",
  ...
  },
  {
    ...
    full: "She has trained extensively in Waldorf pedagogy, biodynamic farming and biography work. Currently, she mentors teachers, leads outdoor education and conducts workshops internationally.",
  },
];
          ...
          return (
            ...
            >
              ...
              <div className="space-y-5">
                <h3 className="font-heading text-primary text-3xl font-semibold">
                  {item.name}
                </h3>
                <p className="text-accent font-body font-medium text-lg max-w-2xl">
                  {item.role}
                </p>
                <p className="text-gray-700 font-body text-base max-w-2xl">
                  {item.short}
                </p>
