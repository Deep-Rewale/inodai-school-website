      ...
      >
        ...
        <motion.div variants={slideLeft} className="space-y-8">
          ...
          <p className="text-gray-700 font-body leading-relaxed">
            Nutritious vegetarian meals are provided daily to support your
            child’s physical well-being and healthy development.
          </p>

          {/* Feature Tags */}
          <div className="flex flex-wrap gap-4 pt-4">
            <div className="bg-[#F8F9FC] flex gap-2 items-center px-6 py-4 rounded-full text-primary font-body text-base shadow-sm">
              {" "}
              <AiOutlineSafety size={25} /> <span> Safe Environment </span>
            </div>

            <div className="bg-[#F8F9FC] flex gap-2 items-center px-6 py-4 rounded-full text-primary font-body text-base shadow-sm">
              {" "}
              <GiMeal size={25} /> <span> Nutritious Meals </span>
            </div>

            <div className="bg-[#F8F9FC] flex gap-2 items-center px-6 py-4 rounded-full text-primary font-body text-base shadow-sm">
              {" "}
              <IoMdHappy size={25} /> <span> Caring Supervision </span>
            </div>
          </div>
        </motion.div>
